...
exports.createServer= function(parameters) {
  ...
  yasw_server.on_open= function(file_extension, response, read_stream, on_headers_written) {
  ...
  yasw_server.static_page= function(page, response, status, on_headers_written) {
    ...
    if (!status)
      status= 200;
    read_stream.on('open', function() { return yasw_server.on_open(file_extension, response, read_stream, on_headers_written); });

  ...
  describe("ShipCommandController", function() {
    ...
    describe("Initial button states", function() {
      it("start fire up", function() {
        return expect(the_gamepad.last_gamepad_state.fire()).toBeFalsy();
      });
      return it("start thrust up", function() {
        return expect(the_gamepad.last_gamepad_state.thrust()).toBeFalsy();
      });
    });
    fire_up_sent_tests = [
      {
